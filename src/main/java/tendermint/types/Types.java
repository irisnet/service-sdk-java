...
public final class Types {
    ...
    public interface CommitOrBuilder extends
        ...
        /**
         * <code>.tendermint.libs.bits.BitArray bit_array = 6;</code>
         *
         ...
         * @return The bitArray.
         */
        tendermint.libs.bits.Types.BitArray getBitArray();

        /**
         * <code>.tendermint.libs.bits.BitArray bit_array = 6;</code>
         */
        tendermint.libs.bits.Types.BitArrayOrBuilder getBitArrayOrBuilder();
    }
    ...
    public static final class Commit extends
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 50: {
                            ...
                            bitArray_ = input.readMessage(tendermint.libs.bits.Types.BitArray.parser(), extensionRegistry);
                            if (subBuilder != null) {
        ...
        public static final int BIT_ARRAY_FIELD_NUMBER = 6;
        private tendermint.libs.bits.Types.BitArray bitArray_;
         ...
         */
        @java.lang.Override
        public tendermint.libs.bits.Types.BitArray getBitArray() {
            return bitArray_ == null ? tendermint.libs.bits.Types.BitArray.getDefaultInstance() : bitArray_;
        }
         ...
         */
        @java.lang.Override
        public tendermint.libs.bits.Types.BitArrayOrBuilder getBitArrayOrBuilder() {
            return getBitArray();
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output)
            ...
            if (bitArray_ != null) {
                output.writeMessage(6, getBitArray());
            }
            unknownFields.writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            if (bitArray_ != null) {
                size += com.google.protobuf.CodedOutputStream
                        .computeMessageSize(6, getBitArray());
            }
            size += unknownFields.getSerializedSize();
            memoizedSize = size;
            return size;
        ...
        public static final class Builder extends
            ...
            private tendermint.libs.bits.Types.BitArray bitArray_;
            private com.google.protobuf.SingleFieldBuilderV3<
                    tendermint.libs.bits.Types.BitArray, tendermint.libs.bits.Types.BitArray.Builder, tendermint.libs.bits.Types.BitArrayOrBuilder> bitArrayBuilder_;
             ...
             * <code>.tendermint.libs.bits.BitArray bit_array = 6;</code>
             */
            public Builder setBitArray(tendermint.libs.bits.Types.BitArray value) {
                if (bitArrayBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
             ...
             * <code>.tendermint.libs.bits.BitArray bit_array = 6;</code>
             */
            public Builder mergeBitArray(tendermint.libs.bits.Types.BitArray value) {
                if (bitArrayBuilder_ == null) {
                    if (bitArray_ != null) {
                        bitArray_ =
                                tendermint.libs.bits.Types.BitArray.newBuilder(bitArray_).mergeFrom(value).buildPartial();
                    } else {
                        bitArray_ = value;
                    }
                    onChanged();
             ...
             * <code>.tendermint.libs.bits.BitArray bit_array = 6;</code>
             */
            public tendermint.libs.bits.Types.BitArray.Builder getBitArrayBuilder() {
            ...
            public tendermint.libs.bits.Types.BitArrayOrBuilder getBitArrayOrBuilder() {
                if (bitArrayBuilder_ != null) {
                    ...
                    return bitArray_ == null ?
                            tendermint.libs.bits.Types.BitArray.getDefaultInstance() : bitArray_;
                }
            }
    ...
    static {
        java.lang.String[] descriptorData = {
                "\n\034tendermint/types/types.proto\022\020tendermi" +
                        ...
                        "rotobuf/timestamp.proto\032 tendermint/libs" +
                        "/bits/types.proto\032\035tendermint/crypto/pro" +
                        "of.proto\032\036tendermint/version/types.proto" +
                        ...
                        "oser_address\030\016 \001(\014\"!\n\004Data\022\013\n\003txs\030\001 \003(\014\022" +
                        "\014\n\004hash\030\002 \001(\014\"\222\002\n\004Vote\022-\n\004type\030\001 \001(\0162\037.t" +
                        "endermint.types.SignedMsgType\022\016\n\006height\030" +
                        "\002 \001(\003\022\r\n\005round\030\003 \001(\005\022<\n\010block_id\030\004 \001(\0132\031" +
                        ".tendermint.types.BlockIDB\017\310\336\037\000\342\336\037\007Block" +
                        "ID\0227\n\ttimestamp\030\005 \001(\0132\032.google.protobuf." +
                        "TimestampB\010\310\336\037\000\220\337\037\001\022\031\n\021validator_address" +
                        "\030\006 \001(\014\022\027\n\017validator_index\030\007 \001(\005\022\021\n\tsigna" +
                        "ture\030\010 \001(\014\"\335\001\n\006Commit\022\016\n\006height\030\001 \001(\003\022\r\n" +
                        "\005round\030\002 \001(\005\022<\n\010block_id\030\003 \001(\0132\031.tenderm" +
                        "int.types.BlockIDB\017\310\336\037\000\342\336\037\007BlockID\0225\n\nsi" +
                        "gnatures\030\004 \003(\0132\033.tendermint.types.Commit" +
                        "SigB\004\310\336\037\000\022\014\n\004hash\030\005 \001(\014\0221\n\tbit_array\030\006 \001" +
                        "(\0132\036.tendermint.libs.bits.BitArray\"\250\001\n\tC" +
                        "ommitSig\0224\n\rblock_id_flag\030\001 \001(\0162\035.tender" +
                        "mint.types.BlockIDFlag\022\031\n\021validator_addr" +
                        "ess\030\002 \001(\014\0227\n\ttimestamp\030\003 \001(\0132\032.google.pr" +
                        "otobuf.TimestampB\010\310\336\037\000\220\337\037\001\022\021\n\tsignature\030" +
                        "\004 \001(\014\"\365\001\n\010Proposal\022-\n\004type\030\001 \001(\0162\037.tende" +
                        "rmint.types.SignedMsgType\022\016\n\006height\030\002 \001(" +
                        "\003\022\r\n\005round\030\003 \001(\005\022\021\n\tpol_round\030\004 \001(\005\022<\n\010b" +
                        "lock_id\030\005 \001(\0132\031.tendermint.types.BlockID" +
                        "B\017\342\336\037\007BlockID\310\336\037\000\0227\n\ttimestamp\030\006 \001(\0132\032.g" +
                        "oogle.protobuf.TimestampB\010\310\336\037\000\220\337\037\001\022\021\n\tsi" +
                        "gnature\030\007 \001(\014\"b\n\014SignedHeader\022(\n\006header\030" +
                        "\001 \001(\0132\030.tendermint.types.Header\022(\n\006commi" +
                        "t\030\002 \001(\0132\030.tendermint.types.Commit\"\236\001\n\tBl" +
                        "ockMeta\022<\n\010block_id\030\001 \001(\0132\031.tendermint.t" +
                        "ypes.BlockIDB\017\342\336\037\007BlockID\310\336\037\000\022\022\n\nblock_s" +
                        "ize\030\002 \001(\003\022.\n\006header\030\003 \001(\0132\030.tendermint.t" +
                        "ypes.HeaderB\004\310\336\037\000\022\017\n\007num_txs\030\004 \001(\003\"S\n\007Tx" +
                        "Proof\022\021\n\troot_hash\030\001 \001(\014\022\014\n\004data\030\002 \001(\014\022\'" +
                        "\n\005proof\030\003 \001(\0132\030.tendermint.crypto.Proof*" +
                        "\327\001\n\013BlockIDFlag\0221\n\025BLOCK_ID_FLAG_UNKNOWN" +
                        "\020\000\032\026\212\235 \022BlockIDFlagUnknown\022/\n\024BLOCK_ID_F" +
                        "LAG_ABSENT\020\001\032\025\212\235 \021BlockIDFlagAbsent\022/\n\024B" +
                        "LOCK_ID_FLAG_COMMIT\020\002\032\025\212\235 \021BlockIDFlagCo" +
                        "mmit\022)\n\021BLOCK_ID_FLAG_NIL\020\003\032\022\212\235 \016BlockID" +
                        "FlagNil\032\010\250\244\036\001\210\243\036\000*\327\001\n\rSignedMsgType\022,\n\027S" +
                        "IGNED_MSG_TYPE_UNKNOWN\020\000\032\017\212\235 \013UnknownTyp" +
                        "e\022,\n\027SIGNED_MSG_TYPE_PREVOTE\020\001\032\017\212\235 \013Prev" +
                        "oteType\0220\n\031SIGNED_MSG_TYPE_PRECOMMIT\020\002\032\021" +
                        "\212\235 \rPrecommitType\022.\n\030SIGNED_MSG_TYPE_PRO" +
                        "POSAL\020 \032\020\212\235 \014ProposalType\032\010\250\244\036\001\210\243\036\000B9Z7g" +
                        "ithub.com/tendermint/tendermint/proto/te" +
                        "ndermint/typesb\006proto3"
        };
        ...
        internal_static_tendermint_types_Commit_fieldAccessorTable = new
                com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_tendermint_types_Commit_descriptor,
                new java.lang.String[]{"Height", "Round", "BlockId", "Signatures", "Hash", "BitArray",});
        internal_static_tendermint_types_CommitSig_descriptor =
