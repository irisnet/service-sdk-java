...
public final class Keys {
    ...
    public interface PrivateKeyOrBuilder extends
            // @@protoc_insertion_point(interface_extends:tendermint.crypto.PrivateKey)
            com.google.protobuf.MessageOrBuilder {
        ...
        public tendermint.crypto.Keys.PrivateKey.SumCase getSumCase();
    }
     ...
     * </pre>
     * <p>
     * Protobuf type {@code tendermint.crypto.PrivateKey}
     */
    public static final class PrivateKey extends
            com.google.protobuf.GeneratedMessageV3 implements
            // @@protoc_insertion_point(message_implements:tendermint.crypto.PrivateKey)
            PrivateKeyOrBuilder {
        private static final long serialVersionUID = 0L;
        ...
        public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
            return tendermint.crypto.Keys.internal_static_tendermint_crypto_PrivateKey_descriptor;
        }

        @java.lang.Override
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
            return tendermint.crypto.Keys.internal_static_tendermint_crypto_PrivateKey_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            tendermint.crypto.Keys.PrivateKey.class, tendermint.crypto.Keys.PrivateKey.Builder.class);
        }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj instanceof tendermint.crypto.Keys.PrivateKey)) {
                return super.equals(obj);
            }
            tendermint.crypto.Keys.PrivateKey other = (tendermint.crypto.Keys.PrivateKey) obj;
        ...
        public static tendermint.crypto.Keys.PrivateKey parseFrom(
                java.nio.ByteBuffer data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }
        ...
        public static tendermint.crypto.Keys.PrivateKey parseFrom(byte[] data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }
        ...
        public static tendermint.crypto.Keys.PrivateKey parseFrom(java.io.InputStream input)
                throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3
                    .parseWithIOException(PARSER, input);
        }
        ...
        public static tendermint.crypto.Keys.PrivateKey parseDelimitedFrom(java.io.InputStream input)
                throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3
                    .parseDelimitedWithIOException(PARSER, input);
        }

        public static tendermint.crypto.Keys.PrivateKey parseDelimitedFrom(
                java.io.InputStream input,
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            return com.google.protobuf.GeneratedMessageV3
        ...
        public static Builder newBuilder(tendermint.crypto.Keys.PrivateKey prototype) {
            return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends
                com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
                // @@protoc_insertion_point(builder_implements:tendermint.crypto.PrivateKey)
                tendermint.crypto.Keys.PrivateKeyOrBuilder {
            public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
                return tendermint.crypto.Keys.internal_static_tendermint_crypto_PrivateKey_descriptor;
            }
            ...
            // Construct using tendermint.crypto.Keys.PrivateKey.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
            ...
            @java.lang.Override
            public tendermint.crypto.Keys.PrivateKey getDefaultInstanceForType() {
                return tendermint.crypto.Keys.PrivateKey.getDefaultInstance();
            }

            @java.lang.Override
            public tendermint.crypto.Keys.PrivateKey build() {
                tendermint.crypto.Keys.PrivateKey result = buildPartial();
                if (!result.isInitialized()) {
                    throw newUninitializedMessageException(result);
                }
                return result;
            ...
            @java.lang.Override
            public tendermint.crypto.Keys.PrivateKey buildPartial() {
                tendermint.crypto.Keys.PrivateKey result = new tendermint.crypto.Keys.PrivateKey(this);
                if (sumCase_ == 1) {
                    result.sum_ = sum_;
                }
                result.sumCase_ = sumCase_;
            ...
            @java.lang.Override
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other instanceof tendermint.crypto.Keys.PrivateKey) {
                    return mergeFrom((tendermint.crypto.Keys.PrivateKey) other);
                } else {
                    super.mergeFrom(other);
                    return this;
                }
            ...
            public Builder mergeFrom(tendermint.crypto.Keys.PrivateKey other) {
                if (other == tendermint.crypto.Keys.PrivateKey.getDefaultInstance()) return this;
                switch (other.getSumCase()) {
                    case ED25519: {
                        setEd25519(other.getEd25519());
                        break;
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                tendermint.crypto.Keys.PrivateKey parsedMessage = null;
                try {
                    parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                    parsedMessage = (tendermint.crypto.Keys.PrivateKey) e.getUnfinishedMessage();
                    throw e.unwrapIOException();
                } finally {
                    if (parsedMessage != null) {
                        mergeFrom(parsedMessage);
            ...
            // @@protoc_insertion_point(builder_scope:tendermint.crypto.PrivateKey)
        }

        // @@protoc_insertion_point(class_scope:tendermint.crypto.PrivateKey)
        private static final tendermint.crypto.Keys.PrivateKey DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE = new tendermint.crypto.Keys.PrivateKey();
        }

        public static tendermint.crypto.Keys.PrivateKey getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
    ...
    private static final com.google.protobuf.Descriptors.Descriptor
            internal_static_tendermint_crypto_PrivateKey_descriptor;
    private static final
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            internal_static_tendermint_crypto_PrivateKey_fieldAccessorTable;
    ...
    static {
        java.lang.String[] descriptorData = {
                "\n\034tendermint/crypto/keys.proto\022\021tendermi" +
                        "nt.crypto\032\024gogoproto/gogo.proto\"/\n\tPubli" +
                        "cKey\022\021\n\007ed25519\030\001 \001(\014H\000:\010\350\241\037\001\350\240\037\001B\005\n\003sum" +
                        "\"&\n\nPrivateKey\022\021\n\007ed25519\030\001 \001(\014H\000B\005\n\003sum" +
                        "B:Z8github.com/tendermint/tendermint/pro" +
                        "to/tendermint/cryptob\006proto3"
        };
        ...
        internal_static_tendermint_crypto_PrivateKey_fieldAccessorTable = new
                com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_tendermint_crypto_PrivateKey_descriptor,
                new java.lang.String[]{"Ed25519", "Sum",});
        com.google.protobuf.ExtensionRegistry registry =
